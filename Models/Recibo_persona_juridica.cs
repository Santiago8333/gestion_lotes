...
public class Recibo_persona_juridica
{
    [Key]
    ...
    [Required(ErrorMessage = "El razon socia de recibo es obligatorio.")]
    public string apoderado_socio {get;set;} = "";
    [Required(ErrorMessage = "El tipo apoderado socio de recibo es obligatorio.")]
